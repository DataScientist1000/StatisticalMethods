...
freq_Malignant_radius_mean = m[0].max()
index_freq_Malignant_radius_mean = list(m[0]).index(freq_Malignant_radius_mean)
most_freq_Malignant_radius_mean  = m[1][index_freq_Malignant_radius_mean]
print("Most frequent malignant radius is : ", most_freq_Malignant_radius_mean)

"""
Most frequent malignant radius is : 20.101999999999997
...
print("Describe : ",data_benign.radius_mean.describe())
...
var_pooled = (len(data_benign)*var_bening +len(data_malignant)*var_malignant ) / float(len(data_benign)+ len(data_malignant))
